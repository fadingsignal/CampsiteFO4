...
Int RotationAmountZ = 10 Const
Int TiltAmount = 2 Const
Int MoveAmountVertical = 3 Const
Int MoveAmountHorizontal = 4 Const
Float SmokeScaleFireOn = 0.5 Const
Float SmokeScaleFireOff = 0.20 Const
...
Int OffsetController = 35 Const
Int OffsetFireOnBackward = 50 Const
Int OffsetFireOnRight = 20 Const
Int OffsetFireOffRight = 0 Const
Int OffsetNPCIdleForward = 100 Const
Int OffsetSmokeBackward = 15 Const
