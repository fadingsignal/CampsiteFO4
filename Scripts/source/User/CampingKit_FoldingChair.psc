ScriptName CampingKit_FoldingChair extends ObjectReference

Message Property MenuChair01 Auto
Message Property MoveMenu01 Auto
Message Property RotateMenu01 Auto
MiscObject Property ItemFoldingChair Auto
...
Int RotationAmountZ = 12

; Menu Functions ================================

Function ShowMainMenu(Int iButton = 0)
	
	iButton = MenuChair01.Show(0, 0, 0, 0, 0, 0, 0, 0, 0)

	If iButton == 0 ;Sit Down
		SitDown()
...
Function SitDown()
	...
	;We can't block activation or the player can't get out of the chair
EndFunction

Function PickUp()
	Self.Disable(false)
	Self.Delete()
	Game.GetPlayer().AddItem(ItemFoldingChair, 1, false)
EndFunction
