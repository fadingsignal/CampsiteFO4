ScriptName CampingKit_Lantern extends ObjectReference

Message Property MenuLantern01 Auto
Message Property MoveMenu01 Auto
Message Property RotateMenu01 Auto
MiscObject Property ItemLantern Auto
...
Function ShowMainMenu(Int iButton = 0)
	...
	iButton = MenuLantern01.Show(0, 0, 0, 0, 0, 0, 0, 0, 0)
...
Function PickUp()
	Self.Disable(false)
	Self.Delete()
	Game.GetPlayer().AddItem(ItemLantern, 1, false)
EndFunction
